...
# curl -X POST -H 'Content-type: application/json' --data @./jenkins/scripts/slack1.json https://hooks.slack.com/services/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